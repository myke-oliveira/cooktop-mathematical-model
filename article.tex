...
\hypersetup{
		...
		pdfkeywords={cooktop}{indução}{eletromagnetismo}{modelagem matemática}{física}{Python3}, 
...
\begin{table}[h] \label{tab:paramentros}
	\begin{tabular}{@{}llll@{}}
		\toprule
...
\begin{table}[h] \label{tab:variaveis}
	\begin{tabular}{@{}llll@{}}
		\toprule
...
\begin{table}[h] \label{tab:contantes}
	\begin{tabular}{@{}lll@{}}
		\toprule
